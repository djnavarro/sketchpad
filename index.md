...
[`twist()`](https://sketchpad.djnavarro.net/reference/twist.md)) that
...
A [`blob()`](https://sketchpad.djnavarro.net/reference/blob.md) is a
circle whose radius is perturbed by simplex noise. Here six blobs are
arranged around a ring, one per colour:
...
A [`ribbon()`](https://sketchpad.djnavarro.net/reference/ribbon.md) is a
tapered, noise-displaced band drawn between two points:
...
A [`twist()`](https://sketchpad.djnavarro.net/reference/twist.md) is
like a ribbon, but follows a Brownian bridge instead of a straight line,
giving it a wandering, twisted appearance:
