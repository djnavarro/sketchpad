...
similar to
[circle](https://sketchpad.djnavarro.net/reference/circle.md), except
that its radius varies smoothly around the circumference according to
Perlin/simplex noise generated with ambient.
