...
- [`group()`](https://sketchpad.djnavarro.net/reference/group.md) : A
  nested collection of drawables sharing one transform/style
...
- [`shape_star()`](https://sketchpad.djnavarro.net/reference/shape_star.md)
  [`shape_stars()`](https://sketchpad.djnavarro.net/reference/shape_star.md)
  : A star
...
- [`fill()`](https://sketchpad.djnavarro.net/reference/fill.md) : A
  resolved or auto-resolving fill value
